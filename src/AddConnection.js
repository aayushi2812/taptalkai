...
function AddConnection() {
  ...
  useEffect(() => {
    const delayDebounce = setTimeout(() => {
      if (email.trim() !== "") {
        axios
          .get(`http://localhost:5000/api/users/search?email=${email}`)
          .then((res) => {
      ...
      >
        ...
        {foundUser && (
          ...
          >
            ...
            <p>
              <strong>Event:</strong> {foundUser.event}
            </p>
            <p>
              <strong>LinkedIn:</strong>{" "}
              <a href={foundUser.linkedin} target="_blank" rel="noreferrer">
                Profile
              </a>
            </p>
            ...
            <Col key={index} sm={12} md={6} lg={4} className="mb-4">
              <Card style={{ width: "18rem" }}>
                <Card.Body>
                  ...
                  <Card.Link href={connection.linkedin}>
                    View Description
                  </Card.Link>
                </Card.Body>
              </Card>
